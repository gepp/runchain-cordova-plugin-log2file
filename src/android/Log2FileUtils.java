package com.runchain.plugins.log2file;
...
public class Log2FileUtils extends CordovaPlugin {
  ...
  private static final org.slf4j.Logger log = LoggerFactory.getLogger(Log2FileUtils.class);
  ...
  private void configureLogger() {
    ...
    FileSize fileSize = new FileSize(1024*1024*5);
